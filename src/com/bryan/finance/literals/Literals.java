...
public abstract class Literals {
	...
	public static final String LOG_NEW_LINE = "\r\n";

	public static final String BUILD_PATH = "build/classes/";
	public static final String CONFIG_DIR = "config/";

	public static final String LOGGER_PROPERTY_FILE = "log4j.properties";
